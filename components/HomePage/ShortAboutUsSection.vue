<template>
  <div id="short-about-us-section" class="bg-stone-400">
    <div
      class="mx-auto grid min-h-[640px] max-w-xl grid-cols-1 place-content-center gap-8 px-6 py-12 md:max-w-7xl md:grid-cols-2"
    >
      <div
